	...
	<nav class="navbar">
		...
		<?php
			...
			if (!isset($_SESSION["login"])) { ?>
					<li>
						<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/login.php"?>"><i class="ri-user-line"></i> Connexion</a>
					</li>
				</ul>
			</nav>
		<?php
			...
			if (in_array("teacher", $roleList)) { ?>
					...
					<li>
						<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/sessioncreation.php"?>"><i class="ri-computer-line"></i> Créer une session</a>
					</li>
					<li>
						<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/session.php"?>"><i class="ri-slideshow-3-line"></i> Voir mes sessions</a>
					</li>
		<?php }
		...
		<?php }
			// If the user is an admin
				...
				<li>
					<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/log.php?trace"?>"><i class="ri-computer-line"></i> Logs</a>
				</li>
		<?php
			}
		...
		?>
			...
			<li><a class="title bold case" href="#"><i class="ri-user-line"></i> <?=$username?></a>
				<ul class="sub">
					<li>
						<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/account.php"?>"><i class="ri-account-circle-line"></i> Compte</a>
					</li>
					<li>
						<a class="title bold" href="<?="http://" . $_SERVER["SERVER_NAME"] . "/setting.php"?>"><i class="ri-settings-4-line"></i> Options</a>
					</li>
					<li>
